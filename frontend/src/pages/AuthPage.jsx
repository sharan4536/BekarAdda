        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input 
              ...
              className="w-full px-4 py-2.5 rounded-lg bg-black/50 border border-white/10 outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all placeholder:text-slate-600"
          ...
          {!isLogin && (
              <div>
                ...
                <input 
                  ...
                  className="w-full px-4 py-2.5 rounded-lg bg-black/50 border border-white/10 outline-none focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-all placeholder:text-slate-600"
          ...
          <div>
            <label className="block text-xs font-bold tracking-wider uppercase text-slate-400 mb-1">Password</label>
            <input 
              type="password" 
